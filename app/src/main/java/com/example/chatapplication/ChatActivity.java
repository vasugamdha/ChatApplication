...
public class ChatActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Picasso.get().load(messageReceiverImage).networkPolicy(NetworkPolicy.OFFLINE).placeholder(R.drawable.profile_image).into(userImage, new Callback() {
            @Override
    ...
    private void DisplayDataOfMessages() {
    ...
    private void IntializeControllers()
    {
        ...
        userImage = (CircleImageView) findViewById(R.id.custom_profile_pic);
        SendFilesButton=(ImageButton) findViewById(R.id.send_file_button);

        SendMessageButton = (ImageButton) findViewById(R.id.private_send_message_button);
        MessageInputText = (EditText) findViewById(R.id.private_message);
